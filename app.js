...
document.addEventListener("DOMContentLoaded", () => {
  // Повторно найти все элементы с классом edit после загрузки контента
...
function switchTheme(e) {
  if (e.target.checked) {
    page.classList.add("alt-theme")
    localStorage.setItem("theme", "alt-theme") // Сохраняем выбор
  } else {
    page.classList.remove("alt-theme")
    localStorage.setItem("theme", "default") // Сохраняем выбор
  }
}
